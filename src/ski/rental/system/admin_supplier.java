...
public class admin_supplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tab_Supplier = new javax.swing.JTabbedPane();
        ...
        tab_Supplier.setForeground(new java.awt.Color(2, 51, 71));
        tab_Supplier.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tab_Supplier.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N

        tbl_supplier.setAutoCreateRowSorter(true);
        tbl_supplier.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        ...
        tbl_supplier.setGridColor(new java.awt.Color(204, 204, 204));
        tbl_supplier.setIntercellSpacing(new java.awt.Dimension(5, 5));
        jScrollPane1.setViewportView(tbl_supplier);

        tab_Supplier.addTab("Supplier", jScrollPane1);

        PM_Dashboard.add(tab_Supplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 790, 370));
        ...
        btn_manageSupplier.setBackground(new java.awt.Color(234, 63, 63));
    ...
    private javax.swing.JTabbedPane tab_Supplier;
